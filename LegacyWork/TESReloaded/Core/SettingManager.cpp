...
void SettingManager::FillMenuSettings(Configuration::SettingList* Settings, const char* Section) {
	...
	bridgeConfig.ambientOcclusionRadius = SettingsAmbientOcclusionExteriors.Range;
	bridgeConfig.ambientOcclusionIntensity = SettingsAmbientOcclusionExteriors.StrengthMultiplier;
	bridgeConfig.ambientOcclusionPower = SettingsAmbientOcclusionExteriors.ClampStrength;
	if (SettingsMain.Shaders.VulkanAmbientOcclusion)
...
bool SettingManager::GetMenuShaderEnabled(const char* Name) {
	...
	else if (!strcmp(Name, "VulkanAmbientOcclusion"))
		Value = SettingsMain.Shaders.VulkanAmbientOcclusion;
